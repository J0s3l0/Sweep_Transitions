package com.mobile.cinetransformer.sweep;
...
//http://facebook.github.io/conceal/ --crypto sd card
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showOtherItems(){
        ...
        ObjectAnimator animWelcome = ObjectAnimator.ofFloat(welcome, View.X, startXWelcome, endWelcome);
